...
function animate() {
    ...
    if(specialBody && specialBody.GetUserData().life<=0){
        ...
        console.log ("El cuerpo especial fue destruido")
    }
...
function listenForContact() {
    ...
    listener.PostSolve = function (contact, impulse) {
        ...
        if (body1 == specialBody || body2 == specialBody) {
            ...
            console.log("El cuerpo especial fue colisionado con impulso ", impulseAlongNormal, " y su vida ahora es ", specialBody.GetUserData().life);
        }
    };
